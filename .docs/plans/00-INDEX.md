...
| **INT-010** (DB Profile Management) | ⏳ **Review (PR #265)** | INT-006-009 | DB-first gating, encrypted credential storage, profile selection logic, deterministic E2E tests, migration & schema alignment |
