...
| INT-006 | Create IRC configuration endpoint (POST /api/integrations/irc/config) | Not Started | P0 | Backend | BE-005 | Saves server, port, username, password to env/db | PVTI_lAHOAB4wV84BNGcwzgj_6MQ | 53 |
| INT-007 | Create IRC connect endpoint (POST /api/integrations/irc/connect) | Not Started | P0 | Backend | INT-006 | Initiates IRC connection, returns connection status | PVTI_lAHOAB4wV84BNGcwzgj_6Mk | 50 |
| INT-008 | Create IRC connection test endpoint (POST /api/integrations/irc/test) | Not Started | P0 | Backend | INT-007 | Attempts connection, returns success/failure response | PVTI_lAHOAB4wV84BNGcwzgj_6MY | 55 |
| INT-009 | Implement IRC connection status endpoint (GET /api/integrations/irc/status) | **Done** (PR #261 merged) | P0 | Backend | INT-005 | Returns current connection status; RBAC admin+; no secrets exposed | PVTI_lAHOAB4wV84BNGcwzgj_6Mc | 57 |
