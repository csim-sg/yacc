...
| GPA-004 | Create AdapterRegistry service | In Review (PR #324) | Phase 2+ | Backend | GPA-002, GPA-003 | `services/adapter-registry.service.ts` with register/connect/disconnect/get methods; lifecycle hooks for register/connected/disconnected/error; multi-profile key cleanup; 85%+ tests + docs | TBD | 314 |
