...
| GPA-003 | Enhance PlatformAdapter interface with metadata and capabilities | In Progress (PR #323) | Phase 2+ | Backend | GPA-001 | `infrastructure/types/adapter.interface.ts` updated with BaseAdapterConfig, AdapterMetadata, AdapterCapability; generic type support | TBD | 313 |
...
| GPA-005 | Migrate TelegramAdapter to new interface | In Progress (PR #323) | Phase 2+ | Backend | GPA-003, GPA-004 | TelegramAdapter implements new PlatformAdapter interface; uses hooks; metadata defined; tests pass | TBD | 315 |
| GPA-006 | Migrate IRCAdapter to new interface | In Progress (PR #323) | Phase 2+ | Backend | GPA-003, GPA-004 | IRCAdapter implements new PlatformAdapter interface; uses hooks; metadata defined; tests pass | TBD | 316 |
