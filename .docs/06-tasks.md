...
| GPA-004 | Create AdapterRegistry service | In Progress (PR #324) | Phase 2+ | Backend | GPA-002, GPA-003 | `services/adapter-registry.ts` with register/connect/disconnect/get methods; lifecycle management; 85%+ test coverage | TBD | 314 |
